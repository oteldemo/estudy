...
(lib.Symbol17 = function(mode,startPosition,loop) {
	...
	this.text.parent = this;
	this.text.setTransform(-3.8,-14.1,1,0.466);
	...
	this.timeline.addTween(cjs.Tween.get(this.text).wait(1).to({scaleX:0.97,scaleY:0.47,x:-6.4,y:-31},0).wait(1).to({scaleX:0.94,scaleY:0.48,x:-9,y:-47.8},0).wait(1).to({scaleX:0.9,scaleY:0.48,x:-11.6,y:-64.5},0).wait(1).to({scaleX:0.87,scaleY:0.49,x:-14.2,y:-81.2},0).wait(1).to({scaleX:0.84,scaleY:0.49,x:-16.7,y:-97.9},0).wait(1).to({scaleX:0.81,scaleY:0.5,x:-19.3,y:-114.5},0).wait(1).to({scaleX:0.77,scaleY:0.5,x:-21.9,y:-131.1},0).wait(1).to({scaleX:0.82,scaleY:0.51,x:-17.8,y:-138},0).wait(1).to({scaleX:0.87,scaleY:0.51,x:-13.8},0).wait(1).to({scaleX:0.92,scaleY:0.52,x:-9.8},0).wait(1).to({scaleX:0.97,scaleY:0.53,x:-5.7},0).wait(1).to({scaleX:1.02,scaleY:0.53,x:-1.6},0).wait(1).to({scaleX:1.07,scaleY:0.54,x:2.4},0).wait(615).to({_off:true},1).wait(3));
...
(lib.Symbol6 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhQAsQghgRAAgbQAAgZAigTQAhgSAuAAQAvAAAiATQAhATAAAdIi5AAQAGASAWAJQAVAIAYAAQAoAAAagSIAhAOQglAbhAAAQgvAAghgTgAhCgOICEAAQgWgZgsAAQguAAgUAZg");
	this.shape.setTransform(113.2,1.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgaBNIAAhfIglAAIAAgYIAlAAIAAgiIAtAAIAAAiIAtAAIAAAYIgtAAIAABfg");
	this.shape_1.setTransform(92.4,-0.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgVBZIAAh3IAsAAIAAB3gAgYg3QgLgGAAgHQAAgJALgFQALgGANAAQAOAAALAGQAKAFAAAJQAAAHgKAGQgLAFgOABQgNgBgLgFg");
	this.shape_2.setTransform(79,-1.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhKAoIAkgKQASAKAUAAQAOAAALgEQALgFAAgFQAAgKglgIQglgIgPgIQgOgHAAgNQAAgOAUgLQAVgJAeAAQAfAAAmARIgeAPIgVgHQgJgDgMABQgbAAAAALQAAAIAjAIQAjAHAQAJQAQAIAAANQgBAPgWAMQgXALgeAAQgtAAgdgXg");
	this.shape_3.setTransform(64.2,1.6);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AghBYQgYgIgOgNIAAAZIgtAAIAAi6IAtAAIAABbQAegbA2ABQAqAAAfASQAfASAAAZQAAAZgeAUQgfASgpABQgZgBgXgHgAg3AEQgVAMAAAQQAAAQAVAMQAWALAfAAQAcAAAWgLQAUgMABgQQAAgQgWgMQgVgLgeAAQgdAAgWALg");
	this.shape_4.setTransform(40.9,-1.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhQAsQghgRAAgbQAAgZAigTQAhgSAuAAQAvAAAiATQAhATAAAdIi5AAQAGASAWAJQAVAIAYAAQAoAAAagSIAhAOQglAbhAAAQgvAAghgTgAhCgOICEAAQgWgZgsAAQguAAgUAZg");
	this.shape_5.setTransform(12.9,1.6);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AAAglIhrCIIiVi9IAvAAIBmCBIBriJIBsCHIBmh/IAvAAIiVC9g");
	this.shape_6.setTransform(-23.3,-1.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AiIBcIAAi3IBSAAQBgAAAvAcQAwAcAAAjQAAAkgyAcQgwAchdAAgAhaBDIADAAQAzAAAagCQAZgDAYgIQAWgJAPgOQANgOAAgRQAAgUgWgRQgWgSgegGQgegFgzAAIgYAAg");
	this.shape_7.setTransform(-80.6,-1.7);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhgBcIAAi3IBDAAQA4AAAkAPQAiAOABAYQAAAYgmAPQgkAQhLgBIAABMgAgzgFQAzAAAYgHQAZgIAAgRQABgNgUgKQgSgJg/AAg");
	this.shape_8.setTransform(-110.5,-1.7);
	...
	this.instance_2.setTransform(-1,-1.8,1.098,0.577,0,0,0,0,-0.1);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A3cHxIAAvhMAu5AAAIAAPhg");
...
}).prototype = getMCSymbolPrototype(lib.Symbol5, new cjs.Rectangle(-164,-52.5,328.4,101.1), null);
...
(lib.Symbol17_1 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.text_1).wait(1).to({scaleX:1.31,scaleY:0.95,x:1.7,y:-144.8},0).wait(1).to({scaleX:1.63,scaleY:0.91,x:0.4,y:-145.8},0).wait(1).to({scaleX:1.67,scaleY:0.93,x:-0.9,y:-148.7},0).wait(1).to({scaleX:1.71,scaleY:0.95,x:-2.1,y:-151.7},0).wait(1).to({scaleX:1.75,scaleY:0.97,x:0.2,y:-148.9},0).wait(1).to({scaleX:1.79,scaleY:0.99,x:0.9,y:-147.9},0).wait(1).to({scaleX:1.83,scaleY:1.02,x:1.6,y:-146.9},0).wait(1).to({scaleX:1.87,scaleY:1.04,x:2.1,y:-146.4},0).wait(1).to({scaleX:1.91,scaleY:1.06,y:-147},0).wait(1).to({scaleX:1.95,scaleY:1.08,x:2.2,y:-147.6},0).wait(1).to({scaleX:1.99,scaleY:1.11,x:2.1,y:-148.2},0).wait(1).to({scaleX:2.03,scaleY:1.13,x:2.2,y:-148.8},0).wait(620));
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(-0.3,-0.1,1.037,1,0,0,0,146.6,50.3);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(1).to({regX:150.9,scaleY:1,x:4.2,y:-11.1},0).wait(1).to({scaleY:1.01,x:4.1,y:-22.2},0).wait(1).to({scaleY:1.01,y:-33.3},0).wait(1).to({scaleY:1.02,x:4,y:-44.3},0).wait(1).to({scaleY:1.02,y:-55.4},0).wait(1).to({scaleY:1.02,x:3.9,y:-66.5},0).wait(1).to({scaleY:1.03,y:-77.6},0).wait(1).to({scaleY:1.03,x:3.8,y:-88.6},0).wait(1).to({scaleY:1.03,y:-99.7},0).wait(1).to({scaleY:1.04,x:3.7,y:-110.8},0).wait(1).to({scaleY:1.04,x:3.6,y:-121.9},0).wait(621));
...
(lib.Symbol6copy3 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AiEBlIAAjGIA0AAIAAAcQAmgfA5AAQAwAAAjAVQAjAUAAAeQAAAdgjAUQgkAWgvAAQgbAAgagIQgZgIgQgPIAABagAg/g9QgYANgBATQABASAYANQAYANAiAAQAhAAAagNQAYgNAAgSQAAgSgYgOQgZgNghAAQgiAAgZANg");
	this.shape.setTransform(111.6,5.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhhAyQgjgUAAgeQAAgcAjgWQAjgUAvAAQAdAAAaAIQAaAJAPANIAAgbIA0AAIAACGIg0AAIAAgbQgnAgg4AAQgxAAgigWgAg0gfQgZANAAASQAAASAYAOQAYAOAiAAQAiAAAYgOQAZgNAAgTQAAgSgZgNQgYgNgiABQghgBgYANg");
	this.shape_1.setTransform(76.3,2.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhsgcIhBCFIgzAAIBpjZIB3CbIB4ibIBpDZIg0AAIg/iEIhuCMg");
	this.shape_2.setTransform(36,-1.6);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhVAtIApgLQAWAMAWAAQARAAAMgGQAMgEAAgHQAAgLgqgJQgrgJgQgIQgRgKAAgNQAAgRAYgMQAXgLAiABQAkgBAsAUIgjARIgYgIQgKgDgOABQgfAAAAAMQAAAJAoAJQApAIARAKQASAKAAAPQAAARgZAMQgaANgjABQg0AAghgbg");
	this.shape_3.setTransform(-15.3,2.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgZBqIAAjTIAzAAIAADTg");
	this.shape_4.setTransform(-32.1,-1.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgZBqIAAjTIAzAAIAADTg");
	this.shape_5.setTransform(-45.6,-1.8);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgZBlIAAiHIAzAAIAACHgAgbg/QgMgGAAgJQAAgJAMgGQAMgHAPAAQARAAAMAHQALAGAAAJQAAAJgLAGQgMAHgRAAQgPAAgMgHg");
	this.shape_6.setTransform(-59.5,-1.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AAvBqIhqhHIAABHIg0AAIAAjTIA0AAIAACIIBmg7IBEAAIhrA9IBsBJg");
	this.shape_7.setTransform(-78.7,-1.8);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("");
	this.shape_8.setTransform(-108.6,-1.6);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(-1,-1.7,1.215,0.671);
...
p.nominalBounds = new cjs.Rectangle(-175.8,-50.5,355.9,101.1);
...
(lib.Symbol6copy2 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AA0A+IAAhPQAAgKgMgGQgNgHgTAAQgYAAgSALQgSALAAAPIAABBIgwAAIAAh4IAwAAIAAAUQAVgMASgGQAQgFAVAAQAgAAAXALQAWAKAAAQIAABWg");
	this.shape.setTransform(115.2,1.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhXAsQgmgSAAgaQAAgZAmgTQAmgTAxAAQAyAAAmATQAlATABAZQAAAZglATQgmAUgwAAQgzAAgngUgAg1gaQgXAMgBAOQAAAQAYALQAXAMAfAAQAfAAAXgMQAXgMAAgPQAAgPgXgMQgXgLgfAAQgfAAgXAMg");
	this.shape_1.setTransform(88.2,1.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgXBaIAAh4IAwAAIAAB4gAgag4QgLgGAAgIQAAgIALgFQALgGAPAAQAQAAALAGQALAFAAAIQAAAIgLAGQgLAGgQAAQgPAAgLgGg");
	this.shape_2.setTransform(67.1,-1.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgcBOIAAhhIgoAAIAAgXIAoAAIAAgjIAwAAIAAAjIAwAAIAAAXIgwAAIAABhg");
	this.shape_3.setTransform(53,-0.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhcAtQgggSAAgbQAAgZAggTQAigTAtAAQAaAAAZAHQAZAJANAMIAAgYIAyAAIAAB3IgyAAIAAgYQgkAcg1AAQguAAghgTgAgxgbQgYAMAAAPQABARAWAMQAXALAfABQAhAAAWgMQAYgMAAgRQAAgPgYgMQgWgMghAAQgeAAgXAMg");
	this.shape_4.setTransform(28.5,1.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AhcBOQghgTAAgbQABgZAggTQAhgSAvAAQAaAAAZAIQAXAIAPAMIAAheIAwAAIAAC9IgwAAIAAgZQgjAdg3AAQgvAAgggTgAgyAEQgYAMAAAQQAAARAYAMQAXAMAeAAQAhAAAXgLQAXgMAAgSQAAgQgXgMQgXgLgfABQghAAgWAKg");
	this.shape_5.setTransform(-3.8,-1.6);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AA0A+IAAhPQAAgKgMgGQgNgHgTAAQgYAAgSALQgSALAAAPIAABBIgwAAIAAh4IAwAAIAAAUQAVgMASgGQAQgFAVAAQAgAAAXALQAWAKAAAQIAABWg");
	this.shape_6.setTransform(-32.1,1.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AhJAvQgcgOAAgYIAAhGIAyAAIAABDQAAAfA0AAQAYAAAOgIQAOgIAAgPIAAhDIAxAAIAABHQAAAXgdAOQgdAPgsAAQgtAAgcgPg");
	this.shape_7.setTransform(-57.5,1.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AhXAsQgmgSAAgaQAAgZAmgTQAmgTAxAAQAyAAAmATQAlATABAZQAAAZglATQgmAUgwAAQgzAAgngUgAg1gaQgXAMgBAOQAAAQAYALQAXAMAfAAQAfAAAXgMQAXgMAAgPQAAgPgXgMQgXgLgfAAQgfAAgXAMg");
	this.shape_8.setTransform(-84.6,1.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AhjBdIAAi6IDHAAIAAAaIiXAAIAAAuICXAAIAAAZIiWAAIAABZg");
	this.shape_9.setTransform(-110.7,-1.6);
...
(lib.Symbol6copy = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AhqA8IAzgOQAbAPAcAAQAVAAAPgGQAPgHAAgIQAAgQg0gMQg1gMgVgLQgUgNAAgSQAAgWAdgQQAdgPArAAQArAAA3AbIgsAWQgRgHgMgDQgMgEgRAAQgnAAAAARQAAANAyALQAyAMAWANQAWANAAAUQAAAXggARQggARgrAAQhAAAgqgkg");
	this.shape.setTransform(110.1,3.3);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AhcBdIAAi0IA/AAIAAAlQAWgWAUgKQAVgKAhAAQAJAAASADIgUAmIgZgCQghAAgVANQgXAOAAAUIAABjg");
	this.shape_1.setTransform(86.6,3.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AhyBEQgvgcAAgoQAAgmAwgcQAugdBDAAQBDAAAvAdQAwAdgBAsIkGAAQAIAcAfANQAeANAjAAQA4AAAlgbIAwAVQg2AphaAAQhEAAgugcgAhfgWIC8AAQgfglg+AAQhCAAgdAlg");
	this.shape_2.setTransform(52.7,3.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhyBEQgvgcAAgoQAAgmAwgcQAugdBDAAQBDAAAvAdQAwAdgBAsIkGAAQAIAcAfANQAeANAjAAQA4AAAlgbIAwAVQg2AphaAAQhEAAgugcgAhfgWIC8AAQgfglg+AAQhCAAgdAlg");
	this.shape_3.setTransform(14.3,3.3);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AhdBdIAAi0IBAAAIAAAlQAWgWAUgKQAVgKAgAAQAKAAARADIgTAmIgZgCQghAAgVANQgWAOgBAUIAABjg");
	this.shape_4.setTransform(-15.6,3.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("Ah5BEQgrgcAAgoQAAgmArgcQAsgdA7AAQAjAAAgAMQAhAMASASIAAglIBBAAIAAC1IhBAAIAAgkQgvAphGAAQg9AAgrgcgAhBgpQgfASAAAXQAAAZAeASQAeASAqAAQAqAAAfgSQAegSAAgYQAAgYgegSQgfgSgqAAQgpAAgeASg");
	this.shape_5.setTransform(-52.2,3.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("Ah9BpQhOgsAAg9QAAg9BNgrQBNgsBsAAQBGAABLATIAAArQhNgXhBAAQhSABg5AfQg5AfAAAuQAAAuA7AgQA6AeBWAAQBAAABHgXIAAAsQhBAUhLAAQhuAAhPgsg");
	this.shape_6.setTransform(-95.8,-1.5);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("A3kH3IAAvsMAvJAAAIAAPsg");
	mask.setTransform(-0.9,-0.3);
...
p.nominalBounds = new cjs.Rectangle(-218.7,-50.5,441.6,101.1);
...
(lib.Symbol6_1 = function(mode,startPosition,loop) {
	...
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("");
	this.shape_10.setTransform(45.7,-1.4);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("");
	this.shape_11.setTransform(-4.2,-1.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AirCXIAAktIFXAAIAAAqIkDAAIAABKIEDAAIAAApIkDAAIAABnIEDAAIAAApg");
	this.shape_12.setTransform(-49.8,-1.4);
	...
	this.instance_10.setTransform(-1.2,-1.7,1.993,0.964,0,0,0,-0.1,-0.1);
...
}).prototype = getMCSymbolPrototype(lib.Symbol5copy2, new cjs.Rectangle(-175.7,-52.5,355.9,101.1), null);
...
(lib.PDallbuttonsversion2 = function(mode,startPosition,loop) {
	...
	this.movieClip_1.setTransform(225.9,204.7,0.401,0.846,0,0,0,0.4,0.5);

	this.instance = new lib.Symbol5copy();
	this.instance.parent = this;
	this.instance.setTransform(351.7,296.4,0.419,0.962);

	this.instance_1 = new lib.Symbol6copy();
	this.instance_1.parent = this;
	this.instance_1.setTransform(351.4,112.8,0.417,0.913,0,0,0,0.7,0.1);
	new cjs.ButtonHelper(this.instance_1, 0, 1, 1);

	this.instance_2 = new lib.Symbol5_1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(478.7,204,0.412,0.839,0,0,0,0.5,0.2);

	this.instance_3 = new lib.Symbol5();
	this.instance_3.parent = this;
	this.instance_3.setTransform(351.4,204.4,0.419,0.847,0,0,0,0.4,0.2);
...
p.nominalBounds = new cjs.Rectangle(843.7,266.5,385.6,276.7);
// library properties:
lib.properties = {
